SponsorBlock_CFLAGS += -Wno-error=vla-cxx-extensionifeq ($(ROOTLESS),1)
...
$(TWEAK_NAME)_CFLAGS = -fobjc-arc -Wno-deprecated-declarations -DTWEAK_VERSION=$(PACKAGE_VERSION) -Wno-error=vla-cxx-extension
